...
WebUI.setText(findTestObject('TC05 - Pay Grades/04 - Edit Currency/TC_031_EditMinSalary/Page_OrangeHRM/input_Minimum Salary_oxd-input oxd-input--focus'), 
    minimumSalary)
...
WebUI.verifyElementVisible(findTestObject('TC05 - Pay Grades/04 - Edit Currency/TC_033_MinSMoreThanMaxS/Page_OrangeHRM/span_Should be higher than Minimum Salary'))

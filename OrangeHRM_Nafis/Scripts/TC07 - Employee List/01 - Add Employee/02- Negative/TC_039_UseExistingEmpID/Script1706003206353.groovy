...
WebUI.verifyElementNotVisible(findTestObject('TC07 - Employee List/01 - Add Employee/TC_039_UseExistingEmpID/Page_OrangeHRM/span_Employee Id already exists'))

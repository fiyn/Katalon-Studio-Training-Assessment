...
WebUI.verifyElementVisible(findTestObject('TC07 - Employee List/01 - Add Employee/TC_038_AddEmployee/Page_OrangeHRM/span_Strong'))
...
WebUI.verifyElementVisible(findTestObject('TC07 - Employee List/01 - Add Employee/TC_044_PasswordConfirmationWrong/Page_OrangeHRM/span_Passwords do not match'))

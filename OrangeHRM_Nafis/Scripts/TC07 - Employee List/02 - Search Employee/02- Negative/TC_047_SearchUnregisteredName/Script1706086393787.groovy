...
WebUI.verifyElementVisible(findTestObject('TC07 - Employee List/02 - Search Employee/TC_047_SearchUnregisteredName/Page_OrangeHRM/span_No Records Found'))

WebUI.verifyElementVisible(findTestObject('TC07 - Employee List/02 - Search Employee/TC_047_SearchUnregisteredName/Page_OrangeHRM/div_InfoNo Records Found'))

...
WebUI.setText(findTestObject('TC07 - Employee List/02 - Search Employee/TC_050_SearchBySVName/Page_OrangeHRM/input_SV Name'), 
    svName)

WebUI.delay(3)

WebUI.click(findTestObject('TC07 - Employee List/02 - Search Employee/TC_050_SearchBySVName/Page_OrangeHRM/div_SV Name Drop-down', 
        [('svName') : svName]))

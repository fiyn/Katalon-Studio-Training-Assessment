...
WebUI.click(findTestObject('TC07 - Employee List/02 - Search Employee/TC_051_SearchBySubUnit/Page_OrangeHRM/i_-- Select Sub Unit'))

WebUI.click(findTestObject('TC07 - Employee List/02 - Search Employee/TC_051_SearchBySubUnit/Page_OrangeHRM/div_sub Sales', 
        [('subUnit') : subUnit]))

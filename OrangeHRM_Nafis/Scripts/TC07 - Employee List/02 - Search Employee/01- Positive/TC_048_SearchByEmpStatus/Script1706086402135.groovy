...
WebUI.click(findTestObject('Object Repository/TC07 - Employee List/02 - Search Employee/TC_048_SearchByEmpStatus/Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-up-fill ox_627fec'))

WebUI.click(findTestObject('TC07 - Employee List/02 - Search Employee/TC_048_SearchByEmpStatus/Page_OrangeHRM/div_Employment Status List', 
        [('empStatus') : empStatus]))

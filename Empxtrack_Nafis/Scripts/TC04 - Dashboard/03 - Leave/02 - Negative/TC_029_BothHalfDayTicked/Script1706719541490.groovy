...
if (isHalfStartDate) {
    WebUI.click(findTestObject('TC04 - Dashboard/03 - Leave/TC_027_ApplyHalfDAyCasualLeave/Page_Home page/input_Half Day Start Date'))
}

if (isHalfEndDate) {
    WebUI.click(findTestObject('TC04 - Dashboard/03 - Leave/TC_027_ApplyHalfDAyCasualLeave/Page_Home page/input_Half Day End Date'))
}

WebUI.verifyElementVisible(findTestObject('TC04 - Dashboard/03 - Leave/TC_029_BothHalfDayTicked/Page_Home page/div_You cannot select both partial days option on the same day of leave'))

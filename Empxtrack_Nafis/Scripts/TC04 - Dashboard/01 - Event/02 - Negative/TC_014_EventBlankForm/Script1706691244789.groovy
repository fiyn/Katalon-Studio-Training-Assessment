...
WebUI.waitForElementVisible(findTestObject('TC04 - Dashboard/01 - Event/Page_Home page/a_Save'), 2)

WebUI.click(findTestObject('TC04 - Dashboard/01 - Event/Page_Home page/a_Save'))

WebUI.verifyElementVisible(findTestObject('TC04 - Dashboard/01 - Event/Page_Home page/div_Please specify the subject'))

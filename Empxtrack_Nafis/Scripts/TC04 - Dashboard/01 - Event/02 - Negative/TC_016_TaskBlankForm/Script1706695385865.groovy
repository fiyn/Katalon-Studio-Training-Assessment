...
WebUI.waitForElementVisible(findTestObject('TC04 - Dashboard/01 - Event/TC_015_AddNewTask/Page_Home page/a_Save'), 2)

WebUI.click(findTestObject('TC04 - Dashboard/01 - Event/TC_015_AddNewTask/Page_Home page/a_Save'))

WebUI.verifyElementVisible(findTestObject('TC04 - Dashboard/01 - Event/TC_016_TaskBlankForm/Page_Home page/div_Please specify the subject'))

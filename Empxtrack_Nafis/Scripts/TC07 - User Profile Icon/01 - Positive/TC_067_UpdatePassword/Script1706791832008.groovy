...
WebUI.waitForElementVisible(findTestObject('TC07 - User Profile Icon/TC_067_UpdatePassword/Page_Home page/div_Password updated successfully'), 
    0)

WebUI.verifyElementVisible(findTestObject('TC07 - User Profile Icon/TC_067_UpdatePassword/Page_Home page/div_Password updated successfully'))

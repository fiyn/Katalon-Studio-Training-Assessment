...
WebUI.waitForElementVisible(findTestObject('TC07 - User Profile Icon/TC_069_PasswordNotMatching/Page_Home page/div_The password does not match the confirmation password entered by you'), 
    2)

WebUI.verifyElementVisible(findTestObject('TC07 - User Profile Icon/TC_069_PasswordNotMatching/Page_Home page/div_The password does not match the confirmation password entered by you'))

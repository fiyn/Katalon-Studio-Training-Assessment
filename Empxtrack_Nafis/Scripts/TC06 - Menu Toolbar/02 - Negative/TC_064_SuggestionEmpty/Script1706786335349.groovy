...
WebUI.waitForElementVisible(findTestObject('TC06 - Menu Toolbar/TC_064_SuggestionEmpty/Page_Home page/div_Please specify area of suggestion'), 
    2)

WebUI.verifyElementVisible(findTestObject('TC06 - Menu Toolbar/TC_064_SuggestionEmpty/Page_Home page/div_Please specify area of suggestion'))

...
WebUI.click(findTestObject('TC05 - Self Services/03 - Attendance/TC_049_ViewDashboard/Page_Home page/a_View attendance dashboard'))

WebUI.waitForElementVisible(findTestObject('TC05 - Self Services/03 - Attendance/TC_049_ViewDashboard/Page_Home page/div_AttendanceHelp'), 
    3)

WebUI.verifyElementVisible(findTestObject('TC05 - Self Services/03 - Attendance/TC_049_ViewDashboard/Page_Home page/div_AttendanceHelp'))

...
WebUI.click(findTestObject('TC05 - Self Services/02 - Leave/TC_046_CancelPendingLeaveReq/Page_Home page/span_Cancelled'))

WebUI.waitForElementVisible(findTestObject('TC05 - Self Services/02 - Leave/TC_046_CancelPendingLeaveReq/Page_Home page/span_Leave Requests'), 
    0)

WebUI.verifyElementVisible(findTestObject('TC05 - Self Services/02 - Leave/TC_046_CancelPendingLeaveReq/Page_Home page/span_Leave Requests'))
